...
import com.example.overseerr_client.data.remote.interceptor.RetryInterceptor
import com.example.overseerr_client.data.security.CertificatePinningManager
...
object NetworkModule {
    ...
    fun provideBaseUrl(): String {
        ...
        return "https://overseerr.example.com"
    }
    ...
    fun provideLoggingInterceptor(): HttpLoggingInterceptor {
        return HttpLoggingInterceptor().apply {
            level = if (com.example.overseerr_client.BuildConfig.DEBUG) {
