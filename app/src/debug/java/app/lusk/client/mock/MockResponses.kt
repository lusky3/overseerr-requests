...
object MockResponses {
    ...
    fun movieDetails(movieId: Int) = ApiMovie(
        ...
        mediaInfo = ApiMediaInfo(
            status = when {
                movieId % 4 == 0 -> 2 // Pending
                movieId % 3 == 0 -> 5 // Available
                else -> 1 // Unknown
            },
            requestId = if (movieId % 4 == 0 || movieId % 3 == 0) movieId else null,
    ...
    fun tvShowDetails(tvId: Int) = ApiTvShow(
        ...
        mediaInfo = ApiMediaInfo(
            status = when {
                tvId % 4 == 0 -> 2 // Pending
                tvId % 3 == 0 -> 5 // Available
                else -> 1 // Unknown
            },
            requestId = if (tvId % 4 == 0 || tvId % 3 == 0) tvId else null,
            available = tvId % 5 == 0
        )
    )
