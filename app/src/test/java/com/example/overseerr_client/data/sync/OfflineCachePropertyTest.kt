package com.example.overseerr_client.data.sync
 ...
 */
private fun mockNetworkManager(): com.example.overseerr_client.data.network.NetworkManager {
    return androidx.test.core.app.ApplicationProvider.getApplicationContext<android.content.Context>()
        .let { context ->
            com.example.overseerr_client.data.network.NetworkManager(context)
        }
}
 ...
 */
private fun mockCacheRepository(): com.example.overseerr_client.domain.repository.CacheRepository {
