package com.example.overseerr_client.mock
        ...
        test("should authenticate with Plex") {
            runTest {
                ...
                val response = authApi.authenticateWithPlex(
                    com.example.overseerr_client.data.remote.model.PlexAuthRequest(
        ...
        test("should submit a request") {
            runTest {
                ...
                val response = requestApi.submitRequest(
                    com.example.overseerr_client.data.remote.model.ApiRequestBody(
                        mediaId = 123,
                        mediaType = "movie"
                    )
                )
