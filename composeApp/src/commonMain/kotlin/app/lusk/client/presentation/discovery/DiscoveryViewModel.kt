...
class DiscoveryViewModel(
    ...
    // Trending content
    val trending: StateFlow<PagingData<app.lusk.client.domain.model.SearchResult>> = 
    ...
    val categoryResults: Flow<PagingData<app.lusk.client.domain.model.SearchResult>> = _selectedCategory
        .filterNotNull()
    ...
    private fun Movie.toSearchResult() = app.lusk.client.domain.model.SearchResult(
        id = id,
    ...
    private fun TvShow.toSearchResult() = app.lusk.client.domain.model.SearchResult(
        id = id,
