 ...
 */
private fun mockNetworkManager(): app.lusk.client.data.network.NetworkManager {
    return androidx.test.core.app.ApplicationProvider.getApplicationContext<android.content.Context>()
        .let { context ->
            app.lusk.client.data.network.NetworkManager(context)
        }
}
 ...
 */
private fun mockCacheRepository(): app.lusk.client.domain.repository.CacheRepository {
